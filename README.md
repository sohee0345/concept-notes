...
개발 및 데이터 분야를 공부하면서 배운 개념을 **주제별로 정리하고 복습하기 위한 개인 학습 저장소**이다.

수업에서 배운 내용을 단순히 기록하는 데 그치지 않고, 개념을 다시 이해하고 필요한 내용을 쉽게 찾아볼 수 있도록 정리한다.
...
학습이 진행됨에 따라 새로운 주제와 세부 카테고리를 계속 추가한다.
...
- 학습이 진행될수록 지속적으로 확장할 수 있는 개인 학습 자료를 만든다.
...
> 학습하면서 새롭게 이해한 내용이나 헷갈렸던 개념을 지속적으로 추가하고 수정한다.